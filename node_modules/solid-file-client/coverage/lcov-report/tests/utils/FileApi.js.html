...
<head>
    <title>Code coverage report for tests/utils/FileApi.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">tests/utils</a> FileApi.js</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-yes">925x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
    _mapUrl(url) {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!url.startsWith(this._prefix)) {
<span class="cstat-no" title="statement not covered" >            console.error('Invalid url', url, this._prefix)</span>
...
&nbsp;
    ...
    delete(url) {
        return fs.promises.unlink(this._mapUrl(url))
            .catch(err =&gt; err.errno === -2 ? { status: 404 } : <span class="branch-1 cbranch-no" title="branch not covered" >err)</span>
    }
    itemExists(url) {
