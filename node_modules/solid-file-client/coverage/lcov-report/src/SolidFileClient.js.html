...
<head>
    <title>Code coverage report for src/SolidFileClient.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">src</a> SolidFileClient.js</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">85.45% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>182/213</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>78/95</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>164/191</span>
            </div>
...
<a name='L496'></a><a href='#L496'>496</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import SolidApi from './SolidApi'
...
&nbsp;
  ...
  async readFile (url, request) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (type &amp;&amp; type.match(/(image|audio|video)/)) { <span class="cstat-no" title="statement not covered" >return res.blob() </span>}
    <span class="missing-if-branch" title="else path not taken" >E</span>if (res.text) { return res.text() }
...
&nbsp;
   ...
   */
<span class="fstat-no" title="function not covered" >  as</span>ync readHead (url, options) {
    const response = <span class="cstat-no" title="statement not covered" >await super.head(url, options)</span>
    let headStr = <span class="cstat-no" title="statement not covered" >''</span>
<span class="cstat-no" title="statement not covered" >    for (var pair of response.headers.entries()) {</span>
<span class="cstat-no" title="statement not covered" >      headStr += pair[0] + ': ' + pair[1] + '\n'</span>
    }
<span class="cstat-no" title="statement not covered" >    return headStr</span>
  }
&nbsp;
  /**
   * delete file
  ...
  async aclUrlParser (url) {
    ...
    for (let i = 0; i &lt; max; i++) {
      ...
      if (links.acl) {
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (target) aclContent = aclContent.replace(new RegExp('&lt;./&gt;', 'g'), '&lt;./' + target + '&gt;')
...
<span class="fstat-no" title="function not covered" > as</span>ync getFolderItemListOLD (path, options) {
<span class="cstat-no" title="statement not covered" >    options = {</span>
      links: SolidFileClient.LINKS.INCLUDE,
      ...options
    }
    const folderData = <span class="cstat-no" title="statement not covered" >await this.readFolder(path, options)</span>
    let itemList
<span class="cstat-no" title="statement not covered" >    if (options.links !== SolidFileClient.LINKS.EXCLUDE) {</span>
<span class="cstat-no" title="statement not covered" >      itemList = [</span>
        ...Object.values(folderData.links),
        ...folderData.files.map(<span class="fstat-no" title="function not covered" >it</span>em =&gt; <span class="cstat-no" title="statement not covered" >[item.url, ...Object.values(item.links)].flat())</span>,
        ...folderData.folders.map(<span class="fstat-no" title="function not covered" >it</span>em =&gt; <span class="cstat-no" title="statement not covered" >item.url)</span>
      ]
    } else {
<span class="cstat-no" title="statement not covered" >      itemList = [</span>
        ...folderData.files.map(<span class="fstat-no" title="function not covered" >it</span>em =&gt; <span class="cstat-no" title="statement not covered" >item.url)</span>,
        ...folderData.folders.map(<span class="fstat-no" title="function not covered" >it</span>em =&gt; <span class="cstat-no" title="statement not covered" >item.url)</span>]
    }
<span class="cstat-no" title="statement not covered" >    return itemList.flat()</span>
  }
&nbsp;
&nbsp;
&nbsp;
...
&nbsp;
    try {
      const type = this.zipSupport().blob ? <span class="branch-0 cbranch-no" title="branch not covered" >'blob' </span>: 'string'
...
<span class="cstat-no" title="statement not covered" >      throw toFetchError(new Error(`getAsZip ${err}`))</span>
    }
  }
&nbsp;
  /**
  ...
  async addItemsToZip (zip, itemList, options) {
    var promises = itemList.map(async item =&gt; {
      ...
      // zip file with links
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (this.zipSupport().blob) {
          const blob = <span class="cstat-no" title="statement not covered" >await this.getFileBlob(item)</span>
<span class="cstat-no" title="statement not covered" >          zip.file(itemName, blob, { binary: true })</span>
        } else {
...
&nbsp;
  ...
  async extractZipArchive (file, destination, options) {
    ...
    try {
      let blob
      <span class="missing-if-branch" title="if path not taken" >I</span>if (this.zipSupport().blob) <span class="cstat-no" title="statement not covered" >blob = await this.getFileBlob(file)</span>
...
<span class="cstat-no" title="statement not covered" >      throw toFetchError(new Error(`extractZipArchive ${err}`))</span>
    }
  }
&nbsp;
  flattenObj (obj, parent, res = {}) {
    ...
    for (const key in obj) {
      const propName = parent ? parent + '_' + key : <span class="branch-1 cbranch-no" title="branch not covered" >key</span>
      if (typeof obj[key] === 'object') {
        this.flattenObj(obj[key], propName, res)
      } else {
        item = propName.includes('err') ? { err: obj[key] } : <span class="branch-1 cbranch-no" title="branch not covered" >{ info: obj[key] }</span>
        res[propName] = item
      }
    }
    ...
    filter = Object.values(res).filter(item =&gt; item.info).map(<span class="fstat-no" title="function not covered" >it</span>em =&gt; <span class="cstat-no" title="statement not covered" >item.info)</span>
...
&nbsp;
   ...
   * @returns {promise}
   */
  async uploadExtractedZipArchive (zip, destination, curFolder = <span class="branch-0 cbranch-no" title="branch not covered" >'',</span> responses, options) {
    options = {
      ...unzipOptions,
      ...options
    }
...
&nbsp;
  async uploadFolderWithLinks (item, destination, zipItems, options) {
    ...
    } catch (e) { <span class="cstat-no" title="statement not covered" >throw toFetchError(new Error('createFolder ' + e)) </span>}
  }
&nbsp;
  async uploadFileWithLinks (item, destination, zipItems, options) {
    ...
    try {
      ...
      contentType = blob.type ? <span class="branch-0 cbranch-no" title="branch not covered" >blob.type </span>: mime.getType(relativePath)
&nbsp;
      await this.createFile(`${destination}${relativePath}`, blob, contentType)
      return await this._uploadLinks(destination, relativePath, zipItems, options)
    } catch (e) { <span class="cstat-no" title="statement not covered" >throw toFetchError(new Error('createFile ' + e)) </span>}
  }
&nbsp;
  async _uploadLinks (destination, relativePath, zipItems, options) {
    try {
      ...
      if (options.links === SolidFileClient.LINKS.INCLUDE) {
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (options.withMeta) {
    ...
    } catch (e) { <span class="cstat-no" title="statement not covered" >throw toFetchError(new Error('uploadLinks ' + e)) </span>}
  }
&nbsp;
  async _uploadItemLink (destination, relativePath, zipItems, linkType, options, linksResponses = []) {
    ...
    try {
      if (zipItemLink) {
        let content
        <span class="missing-if-branch" title="if path not taken" >I</span>if (this.zipSupport().blob) {
          const blob = <span class="cstat-no" title="statement not covered" >await zipItemLink.async('blob')</span>
<span class="cstat-no" title="statement not covered" >          content = await blob.text()</span>
    ...
    } catch (e) { <span class="cstat-no" title="statement not covered" >throw toFetchError(new Error('_uploadItemLink ' + e)) </span>}
  }
&nbsp;
  /**
  ...
  async _uploadLinkFile (path, fileName, content, options) {
    ...
    try {
      ...
      else <span class="missing-if-branch" title="else path not taken" >E</span>if (linkExt === 'meta') isValidLink = await this.isValidRDF(linkParent, content)
      if (isValidLink.err.length) return [{ err: [`${fileName} : ${isValidLink.err} ${isValidLink.info}`] }]
&nbsp;
      // find and create link file
      var linkRes = []
      <span class="missing-if-branch" title="if path not taken" >I</span>if (isValidLink.info.length) <span class="cstat-no" title="statement not covered" >linkRes = [{ info: [`${fileName} : ${isValidLink.info}`] }]</span>
      ...
      return linkRes
    } catch (e) { <span class="cstat-no" title="statement not covered" >throw toFetchError(new Error('_uploadLinkFile ' + e)) </span>}
  }
&nbsp;
