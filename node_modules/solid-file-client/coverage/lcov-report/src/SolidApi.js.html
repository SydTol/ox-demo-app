...
<head>
    <title>Code coverage report for src/SolidApi.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">src</a> SolidApi.js</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">91.35% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>169/185</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>79/97</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>162/177</span>
            </div>
...
class SolidAPI {
  ...
  constructor (fetch, options) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (options.enableLogging) {
<span class="cstat-no" title="statement not covered" >      if (typeof options.enableLogging === 'string') {</span>
<span class="cstat-no" title="statement not covered" >        debug.enable(options.enableLogging)</span>
      } else {
<span class="cstat-no" title="statement not covered" >        debug.enable('solid-file-client:*')</span>
      }
    }
  }
&nbsp;
...
&nbsp;
   ...
   * @returns {Promise&lt;Response&gt;}
   */
<span class="fstat-no" title="function not covered" >  op</span>tions (url, options) {
<span class="cstat-no" title="statement not covered" >    return this.fetch(url, {</span>
      ...options,
      method: 'OPTIONS'
    })
  }
...
&nbsp;
  ...
  async createFolder (url, options) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!url.endsWith('/')) {
<span class="cstat-no" title="statement not covered" >      throw toFetchError(new Error(`Cannot use createFolder to create a file : ${url}`))</span>
    }
&nbsp;
    try {
      // Test if item exists
...
&nbsp;
  ...
  postFile (url, content, contentType, options) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (url.endsWith('/')) {
<span class="cstat-no" title="statement not covered" >      throw toFetchError(new Error(`Cannot use postFile to create a folder : ${url}`))</span>
    }
...
&nbsp;
  ...
  async putFile (url, content, contentType, options) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (url.endsWith('/')) {
<span class="cstat-no" title="statement not covered" >      throw toFetchError(new Error(`Cannot use putFile to create a folder : ${url}`))</span>
    }
&nbsp;
...
&nbsp;
  ...
  async patchFile (url, patchContent, patchContentType) {
    ...
    if (patchContentType === 'text/n3') {
      ...
      } catch (err) { <span class="cstat-no" title="statement not covered" >throw toFetchError(new Error('400 : ' + err)) </span>}
    }
    const requestOptions = {
      headers: {
        link: LINK.RESOURCE,
    ...
    try {
      ...
      e.message = e.status + ' : '
      e.message += patchErrors[e.status] ? patchErrors[e.status] : <span class="branch-1 cbranch-no" title="branch not covered" >'' </span>// e.statusText
...
&nbsp;
  ...
  async readFolder (url, options) {
    url = url.endsWith('/') ? url : <span class="branch-1 cbranch-no" title="branch not covered" >url + '/'</span>
    options = {
      links: LINKS.EXCLUDE,
      ...options
    }
...
&nbsp;
  ...
  async copyFile (from, to, options) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (from.endsWith('.acl') || to.endsWith('.acl')) {
<span class="cstat-no" title="statement not covered" >      throw toFetchError(new Error(`Use copyAclFile for copying ACL files. Found: ${from} and ${to}`))</span>
    }
&nbsp;
    // Copy File
...
&nbsp;
  ...
  async _linkUrlsDefined (from, to) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof from !== 'string') {
<span class="cstat-no" title="statement not covered" >      return false</span>
    } else <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof to !== 'string' &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >await this.itemExists(from))</span> {
<span class="cstat-no" title="statement not covered" >      throw toFetchError(new Error('Cannot copy link file because target location was not provided by the pod'))</span>
    } else <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof to !== 'string') {
<span class="cstat-no" title="statement not covered" >      return false</span>
    } else {
      return true
    }
...
&nbsp;
  ...
  async copyMetaFileForItem (oldTargetFile, newTargetFile, options = {}) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!(await this._linkUrlsDefined(metaFrom, metaTo))) {
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!(await this._linkUrlsDefined(aclFrom, aclTo))) {
<span class="cstat-no" title="statement not covered" >      return undefined</span>
    }
&nbsp;
...
&nbsp;
  ...
  copy (from, to, options) {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (areFiles(from, to)) {
      return this.copyFile(from, to, options)
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    toFetchError(new Error('Cannot copy from a folder url to a file url or vice versa'))</span>
  }
&nbsp;
  /**
...
&nbsp;
  ...
  rename (url, newName, moveOptions) {
    const to = getParentUrl(url) + newName + (areFolders(url) ? <span class="branch-0 cbranch-no" title="branch not covered" >'/' </span>: '')
...
function catchError (callback) {
  return err =&gt; {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!callback(err)) { <span class="cstat-no" title="statement not covered" >throw toFetchError(err) </span>}
    return err
  }
}
&nbsp;
