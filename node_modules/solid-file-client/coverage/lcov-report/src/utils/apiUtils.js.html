...
<head>
    <title>Code coverage report for src/utils/apiUtils.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/utils</a> apiUtils.js</h1>
        <div class='clearfix'>
...
<a name='L75'></a><a href='#L75'>75</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">11x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const LINK = {
...
const getRootUrl = url =&gt; {
  ...
  for (let i = 1; i &lt; base.length - 1; i++) {
    j = i
    <span class="missing-if-branch" title="else path not taken" >E</span>if (base[i] === '') { rootUrl += '/' }
    break
  }
