...
<head>
    <title>Code coverage report for src/utils/rdf-query.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/utils</a> rdf-query.js</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">89.93% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>134/149</span>
            </div>
...
<a name='L377'></a><a href='#L377'>377</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-no">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">2385x</span>
<span class="cline-any cline-yes">2x</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-yes">2369x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">2678x</span>
<span class="cline-any cline-yes">2673x</span>
...
&nbsp;
   ...
   * @returns {string} url
   */
<span class="fstat-no" title="function not covered" >  ge</span>tPrefix (prefix) {
<span class="cstat-no" title="statement not covered" >    return this.prefix[prefix]</span>
  }
&nbsp;
  /**
  ...
  _solidNsToQuad (url, s, p, o, g) {
    ...
    return [s, p, o, g] = [s, p, o, g].map(term =&gt; {
      if (typeof term === 'object' &amp;&amp; term) {
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (this.prefix[prefix]) return namedNode(this.prefix[prefix] + value)
<span class="cstat-no" title="statement not covered" >        return namedNode(prefix + value)</span>
      }
...
&nbsp;
  ...
  async addQuad (url, s, p, o, g) {
    [s, p, o].map(term =&gt; { <span class="missing-if-branch" title="if path not taken" >I</span>if (!term) <span class="cstat-no" title="statement not covered" >throw new Error('400 : triple must be defined') </span>})
    g = this._solidNsToQuad(url, s, p, o, g)
&nbsp;
    const store = this.cache[url]
...
<span class="cstat-no" title="statement not covered" >          return reject(error) </span>// or 400 : 'error'
        }
        resolve(result)
      })
    })
...
&nbsp;
    typeList = typeList.map(item =&gt; {
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (!(baseIRI &amp;&amp; item.includes(baseIRI))) {
        let test = ''
        ...
        for (const i in solidPrefixes) {
          if (item.indexOf(ns[solidPrefixes[i]]('')) === 0) {
            ...
            <span class="missing-if-branch" title="if path not taken" >I</span>if (test !== 'rdf') <span class="cstat-no" title="statement not covered" >prefixes[test] = ns[test]('')</span>
            break
          }
        }
        // create other namedNode terms
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!test) {
          const itemSplit = <span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >(s</span>tring) =&gt; {</span>
            const i = <span class="cstat-no" title="statement not covered" >item.lastIndexOf(string)</span>
<span class="cstat-no" title="statement not covered" >            if (i !== -1) <span class="cstat-no" title="statement not covered" >return item.substring(0, i + 1)</span></span>
          }
          const res = <span class="cstat-no" title="statement not covered" >itemSplit('#') ? itemSplit('#') : (itemSplit('/') ? itemSplit('/') : '')</span>
<span class="cstat-no" title="statement not covered" >          if (res) {</span>
<span class="cstat-no" title="statement not covered" >            pred.add(res)</span>
          }
        }
      }
    })
...
<span class="cstat-no" title="statement not covered" >      prefixes['n' + i] = types[i]</span>
    }
    return prefixes
  }
&nbsp;
  ...
  async _getTermList (type, quadsArray) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!res) <span class="cstat-no" title="statement not covered" >throw (new Error(`400 : invalid termType : ${type}`))</span>
    const getList = {}
    for (const i in quadsArray) {
      const term = quadsArray[i][type].value
      <span class="missing-if-branch" title="else path not taken" >E</span>if (quadsArray[i][type].termType === 'NamedNode') getList[term] = '' // quadsArray[i][type].termType
    }
...
&nbsp;
  ...
  _makeRelativeUrl (turtle, url) {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (turtle.includes(url)) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (turtle.includes(folder)) {
<span class="cstat-no" title="statement not covered" >      turtle = turtle.replace(new RegExp(`&lt;${folder}(.*?)&gt;`, 'g'), '&lt;./$1&gt;')</span>
      // or the 2 lines
      // turtle = '@prefix c: &lt;./&gt;.\n' + turtle
