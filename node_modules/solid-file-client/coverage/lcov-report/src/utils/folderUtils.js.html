...
<head>
    <title>Code coverage report for src/utils/folderUtils.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/utils</a> folderUtils.js</h1>
        <div class='clearfix'>
 ...
 * @returns {FolderData}
 */
const parseFolderResponse = async (folderResponse, folderUrl = <span class="branch-0 cbranch-no" title="branch not covered" >folderResponse.url)</span> =&gt; {
...
function _processStatements (url, stmts) {
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (processed.type === undefined) <span class="cstat-no" title="statement not covered" >processed.type = 'application/octet-stream'</span>
