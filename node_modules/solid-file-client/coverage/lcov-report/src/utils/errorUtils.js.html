...
<head>
    <title>Code coverage report for src/utils/errorUtils.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/utils</a> errorUtils.js</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">// Error classe for wrapping a single failed request as Error
...
&nbsp;
    ...
    } else <span class="missing-if-branch" title="else path not taken" >E</span>if (rejectedErrors.length === 1 &amp;&amp; !errors.length) {
      // Single fetch error
...
<span class="cstat-no" title="statement not covered" >      this.message = `${this.name} ${[...rejectedErrors, ...errors].map(<span class="fstat-no" title="function not covered" >er</span>r =&gt; <span class="cstat-no" title="statement not covered" >err.message)</span>.join('\n')}`</span>
<span class="cstat-no" title="statement not covered" >      this.status = -2</span>
<span class="cstat-no" title="statement not covered" >      this.statusText = this.message</span>
    }
&nbsp;
...
async function composedFetch (promises) {
  ...
  /** @type {FetchError[]} */
  const rejectedPromises = res.filter(({ status }) =&gt; status === 'rejected').map(<span class="fstat-no" title="function not covered" >({</span> reason }) =&gt; <span class="cstat-no" title="statement not covered" >reason)</span>
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (rejectedPromises.length) {
    const errors = <span class="cstat-no" title="statement not covered" >[].concat(...rejectedPromises.map(<span class="fstat-no" title="function not covered" >er</span>r =&gt; <span class="cstat-no" title="statement not covered" >err.errors)</span>)</span>
    const rejectedErrors = <span class="cstat-no" title="statement not covered" >[].concat(...rejectedPromises.map(<span class="fstat-no" title="function not covered" >er</span>r =&gt; <span class="cstat-no" title="statement not covered" >err.rejectedErrors)</span>)</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    throw new FetchError({ successful, rejectedErrors, errors })</span>
  }
&nbsp;
  return successful
}
...
function toFetchError (err) {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (err instanceof FetchError) {
<span class="cstat-no" title="statement not covered" >    throw err</span>
  } else <span class="missing-if-branch" title="if path not taken" >I</span>if (err instanceof SingleResponseError) {
<span class="cstat-no" title="statement not covered" >    throw new FetchError({ rejectedErrors: [err] })</span>
  } else <span class="missing-if-branch" title="else path not taken" >E</span>if (err instanceof Error) {
