...
<head>
    <title>Code coverage report for src/utils/aclParser.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/utils</a> aclParser.js</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">96.43% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>270/280</span>
            </div>
        
            
            <div class='fl pad1y space-right2'>
                <span class="strong">92.22% </span>
                <span class="quiet">Branches</span>
                <span class='fraction'>154/167</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>248/255</span>
            </div>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import apiUtils from './apiUtils'
...
const _updateAccess = (userAccess, add) =&gt; {
  ...
  for (const i in userAccess) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!aclAccesses.find(item =&gt; item === userAccess[i])) {
<span class="cstat-no" title="statement not covered" >      throw toFetchError(new Error(userAccess[i] + ' is an unknown access type'))</span>
    }
    addAccess[userAccess[i]] = add ? 1 : <span class="branch-1 cbranch-no" title="branch not covered" >0</span>
  }
  return addAccess
}
&nbsp;
  ...
  async addUserMode (aclAgents, userAgent, userMode, userAccess = ['accessTo', 'default']) {
    ...
    if (userAgent &amp;&amp; userAgent.length) {
      for (const j in userAgent) {
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (!aclAgents || !aclAgents[user]) {
          aclAgents[user] = {
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (userAccess &amp;&amp; userAccess.length) {
          aclAgents[user].access = Object.assign(aclAgents[user].access, _updateAccess(userAccess, true))
        } else { <span class="cstat-no" title="statement not covered" >throw toFetchError(new Error('no modes in userMode')) </span>}
      }
      return aclAgents
    }
...
&nbsp;
  ...
  async deleteUserMode (aclAgents, userAgent, userMode, userAccess) {
    if (Array.isArray(aclAgents) || !Array.isArray(userAgent) || (userMode &amp;&amp; !Array.isArray(userMode)) || (userAccess &amp;&amp; <span class="branch-5 cbranch-no" title="branch not covered" >!Array.isArray(userAccess))</span>) {
      throw toFetchError(new Error('Parameters should be Arrays, except first'))
    }
    if (userAgent &amp;&amp; userAgent.length) {
      for (const j in userAgent) {
        ...
        let modeValue = 0
        let accessValue = 0
        <span class="missing-if-branch" title="else path not taken" >E</span>if (aclAgents[user]) {
          if (userMode &amp;&amp; userMode.length) {
          ...
          <span class="missing-if-branch" title="if path not taken" >I</span>if (userAccess &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >userAccess.length)</span> {
<span class="cstat-no" title="statement not covered" >            aclAgents[user].access = Object.assign(aclAgents[user].access, _updateAccess(userAccess, false))</span>
            let i = <span class="cstat-no" title="statement not covered" >1</span>
<span class="cstat-no" title="statement not covered" >            for (const j in aclAgents[user].access) {</span>
<span class="cstat-no" title="statement not covered" >              accessValue = accessValue + aclAgents[user].access[j] * i</span>
<span class="cstat-no" title="statement not covered" >              i = i * 2</span>
            }
          }
          // remove 'user' if no mode, or if no accessTo and no default
          <span class="missing-if-branch" title="else path not taken" >E</span>if (!modeValue || <span class="branch-1 cbranch-no" title="branch not covered" >!accessValue)</span> delete aclAgents[user]
        }
      }
      return aclAgents
    }
...
&nbsp;
  ...
  async isValidAcl (itemUrl, aclContent, options) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (resAcl.err === ['incorrect RDF']) <span class="cstat-no" title="statement not covered" >return resAcl</span>
...
&nbsp;
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if ((aclAgent.length + aclAgentClass.length + aclAgentGroup) === '0') <span class="cstat-no" title="statement not covered" >res.err = res.err.concat([`"${aclItem.split('#')[1]}" has no user`])</span>
&nbsp;
      // check for accessTo
...
&nbsp;
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (!aclMode.length) <span class="cstat-no" title="statement not covered" >res.err = res.err.concat([`"${aclItem.split('#')[1]}" has no acl:mode`])</span>
      else {
